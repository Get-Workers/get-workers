        ...
        >
            <div class="px-5 py-3">
                ...
                <div class="mt-1 flex flex-col h-full">
                    ...
                    <div class="mt-1 grid gap-2 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                        <template v-if="scheduledTo">
                            <div>
                                <span class="font-semibold" :title="$t('words.scheduled')">{{ $t('words.scheduled') }}</span>

                                <div class="flex items-center" :title="`${scheduledTo.toLocaleDateString()}-${scheduledTo.toLocaleTimeString()}`">
                        ...
                        <template v-if="initiatedAt">
                            <div>
                                ...
                                <div class="flex items-center" :title="`${initiatedAt.toLocaleDateString()}-${initiatedAt.toLocaleTimeString()}`">
                        ...
                        <template v-if="doneAt">
                            <div>
                                <span class="font-semibold" :title="$t('words.done')">{{ $t('words.done') }}</span>

                                <div class="flex items-center" :title="`${doneAt.toLocaleDateString()}-${doneAt.toLocaleTimeString()}`">
